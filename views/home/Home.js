...
import iconlogot from '../../resources/logotipomini.png';
        ...
        <View style={styles.row}>
          <ScrollView
            ...
            <View
              ...
              <Text style={styles.txttppro}>Dormitorio</Text>
            </View>
            <View style={active === 'viajes' ? styles.boxactive : styles.box5}>
              ...
              <Text style={styles.txttppro}>Viajes</Text>
            </View>
            <View style={active === 'baño' ? styles.boxactive : styles.box5}>
              ...
              <Text style={styles.txttppro}> Baño</Text>
            </View>
            <View
              style={
              ...
              <Text style={styles.txttppro}> Alimentacion</Text>
            </View>
          </ScrollView>
        </View>
