...
import logomini from '../../../resources/logotipomini.png';
      ...
      <ImageBackground source={backappme} style={styles.image}>
        ...
        <Animated.View
          ...
          <View style={styles.center1}>
            <Text style={styles.texbie1}>Ahora Wua-Wua tiene su propia</Text>
            <Text style={styles.texbie1}>App y sin duda será tu favorita</Text>
          </View>
        </Animated.View>
      </ImageBackground>
    </View>
