...
import backappme from '../../../resources/AppMe-bg-blue.png';
        ...
        <Animated.View
          ...
          <View style={styles.center1}>
            <Text style={styles.texbie1}>
              Puedes comprar, pagar y solicitar
            </Text>
            <Text style={styles.texbie1}>
              delivery de tus productos favoritos
            </Text>
            <Text style={styles.texbie1}>
              fácilmente, las veces que tú quieras.
            </Text>
          </View>
        </Animated.View>
      </ImageBackground>
